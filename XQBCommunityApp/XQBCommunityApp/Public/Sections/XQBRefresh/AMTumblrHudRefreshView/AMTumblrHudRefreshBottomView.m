//
//  AMTumblrHudRefreshBottomView.m
//  XQBCommunityApp
//
...
@interface AMTumblrHudRefreshBottomView()

@property (nonatomic, strong) AMTumblrHud *tumblrHUD;

@end

@implementation AMTumblrHudRefreshBottomView
...
- (AMTumblrHud *)tumblrHUD{
    if (!_tumblrHUD) {
        _tumblrHUD = [[AMTumblrHud alloc] initWithFrame:CGRectMake(self.frame.size.width/2-25, 15, 55, 30)];
